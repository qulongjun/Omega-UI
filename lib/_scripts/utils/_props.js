...
const _computedAPI = {
    ...
    _computedAttribute: (props = {}, _sysAttribute = {}) => {
 ...
 * @private
 */
const _elementProps = (props = {}, _sysProps = {}, _excludeProps = [], isDOMElement = false) => {
    const {_sysClass = [], _sysStyle = {}, _sysAttribute = {}, _sysHandle = {}} = _sysProps;
    let _finalProps = {};
    _excludeProps = [].concat(_excludeProps, 'children');
    ...
    if (isDOMElement) {
        ...
        _buildProps = Object.assign({}, {
            className: _computedAPI._computedClass(props, _sysClass),
            style: _computedAPI._computedStyle(props, _sysStyle)
        }, _computedAPI._computedAttribute(props, _sysAttribute), _computedAPI._computedHandle(props, _sysHandle));
    } else {
        // Component元素
        _buildProps = Object.assign({}, _finalProps, {
            ...
            _includeAttribute: _computedAPI._computedAttribute(props, _sysAttribute),
